...
\begin{tabular}{@{}lll@{}}
        ...
        \midrule
		\specialcell[t]{ The application will allow users to create a new account \\with the application} & Yes  & \specialcell[t]{Minor drawback: the user should not be allowed\\ to access all the features of the website before verifying their email address. } \\ % aligned with top rule
