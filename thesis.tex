...
\usepackage{url, graphicx,parskip,bibunits,appendix,float}
\usepackage{geometry}
 \geometry{
 a4paper,
 total={210mm,297mm},
...
\hypersetup{
    pdftitle    = {Football Betting Application},
...
\title{\huge{Football Betting Application}}
